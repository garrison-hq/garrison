...
INSERT INTO agents (id, department_id, role_slug, agent_md, model, listens_for, skills, palace_wing, status)
VALUES
  -- Engineering: 5 specialised roles
  ...
  ('00000000-0000-0000-0000-0000000a0002',
   '00000000-0000-0000-0000-00000000d001',
   'backend-engineer',
   '# Backend engineer (dev-stack seed)',
   'claude-sonnet-4-6',
   '["todo", "in_dev"]'::jsonb,
   '["agent-md", "drizzle-migrations", "postgres-tuning", "github-pr-authoring"]'::jsonb,
   'wing_engineering',
   'active'),
  ('00000000-0000-0000-0000-0000000a0003',
   '00000000-0000-0000-0000-00000000d001',
   'frontend-engineer',
   '# Frontend engineer (dev-stack seed)',
   'claude-sonnet-4-6',
   '["todo", "in_dev"]'::jsonb,
   '["agent-md", "react-19", "tailwind-design-system", "playwright-dev", "github-pr-authoring"]'::jsonb,
   'wing_engineering',
   'active'),
  ...
  ('00000000-0000-0000-0000-0000000a0008',
   ...
   'wing_qa',
   'active'),
  -- Documentation: 2 roles
  ('00000000-0000-0000-0000-0000000a0009',
   '00000000-0000-0000-0000-00000000d003',
   'tech-writer',
   '# Tech Writer (dev-stack seed)',
   'claude-haiku-4-5',
   '["todo"]'::jsonb,
   '["agent-md", "markdown-style-guide"]'::jsonb,
   'wing_docs',
   'active'),
  ('00000000-0000-0000-0000-0000000a000a',
   '00000000-0000-0000-0000-00000000d003',
   'api-docs-writer',
