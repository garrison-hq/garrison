...
**M7 — First custom agent end-to-end (hiring + per-agent runtime + immutable preamble).** Three threads merge into one ship (scope expansion 2026-05-02; see `docs/research/m7-spike.md` §4 for the merge rationale):
